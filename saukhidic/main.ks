...
I'm back from the hot spring[p]
I've been playing a lot, so it's already night[p]
[jump target="*night"]
[endif]
;***********************************************************************************************************************
;-エンディング判別
...
[bg storage="room_night.png" time="1000"]
#
Sakurako is angry or I won't come back ...[p]
I wonder if my mood will be fixed tomorrow[p]
...
#
By the way, today is a festival[p]
[endif]
...
#
Speaking of which, I was doing a fortune in the shopping street[r]
The first is a hot spring trip[p]
If you hit it, you can put a mixed bath together ...[p]
...
[if exp="tf.place == 1"]
 [cm]
  [if exp="f.partner == 0"]
#
I wonder if I'm going home today[p]
  [endif]
 [jump target="*evening"]
[endif]
;外出回数増加 ３回で帰宅
...
#
Should I have about 2000 yen for a game.[p]
[jump target="*date_back"]
[endif]
;■カラオケ
[if exp="tf.date_select == 3 && f.money < 3000"]
If you are karaoke, you should cost about 3000 yen[p]
[jump target="*date_back"]
[endif]
;■漫画喫茶
[if exp="tf.date_select == 4 && f.money < 3000"]
It would be better to have about 3000 yen for a manga cafe[p]
[jump target="*date_back"]
[endif]
;■カフェ
[if exp="tf.date_select == 5 && f.money < 3000"]
If you invite to a cafe, you should have about 3000 yen[p]
[jump target="*date_back"]
[endif]
;■遊園地
[if exp="tf.date_select == 6 && f.money < 6000"]
I wonder if 6000 yen is required for an amusement park[p]
[jump target="*date_back"]
[endif]
;■お祭り
[if exp="tf.date_select == 7 && f.money < 5000"]
I wonder if at least 5000 yen is required[p]
[jump target="*date_back"]
[endif]
;■映画
[if exp="tf.date_select == 10 && f.money < 3000"]
I wonder if at least 3000 yen is required[p]
[jump target="*date_back"]
[endif]
;■居酒屋
...
Rina -chan's rice was delicious today[p]
Riko is crazy about TV ...[p]
Shizue is drinking alcohol[p]
Rina -chan is doing washing[p]
...
[chara_hide name="sakurako"]
[clearstack]
Save data from V1.01, V1.02, please save here for conversion.[r]
...
*sleep
#
By the way, I wonder if I write a diary and sleep[p]
今日は
[emb exp="f.day"]日、
[emb exp="f.week[for.one week]"][p]
;セーブ画面移動
